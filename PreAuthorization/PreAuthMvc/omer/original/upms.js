...
(function (window, undefined) {
    ...
    $.ajaxSetup({
        statusCode: {
            500: function () {
                window.location.href = upmsUtils.getDomainHead() + "page/error500.html";
            }, 404: function () {
                window.location.href = upmsUtils.getDomainHead() + "page/error404.html";
            }
        }
    });
    // ajax方法全局E
